...
class DailyCashController: UIViewController, TransactionCellDelegate  {
    ...
    let transactions = [
        Transaction(title: "Bloomingdale's", city: "Chicago", state: "IL", date: "Just now", price: 15.78, image: #imageLiteral(resourceName: "daily cash")),
        Transaction(title: "South Loop Market", city: "Chicago", state: "IL", date: "Just now", price: 2.71, image: #imageLiteral(resourceName: "daily cash")),
        Transaction(title: "La Colombe Coffee", city: "Chicago", state: "IL", date: "Just now", price: 0.37, image: #imageLiteral(resourceName: "daily cash")),
        Transaction(title: "Apple Store", city: "Chicago", state: "IL", date: "Yesterday", price: 17.34, image: #imageLiteral(resourceName: "daily cash")),
        Transaction(title: "Walgreens", city: "Chicago", state: "IL", date: "Yesterday", price: 1.60, image: #imageLiteral(resourceName: "daily cash")),
        Transaction(title: "Macys", city: "Chicago", state: "IL", date: "Yesterday", price: 8.47, image: #imageLiteral(resourceName: "daily cash")),
    ]
    ...
    override func viewDidLoad() {
        ...
        let headerView = HeaderView(frame: view.frame, image: #imageLiteral(resourceName: "daily cash"), title: "Daily Cash", subTitle: "Apple Card")
